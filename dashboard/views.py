...
class DashboardViewSet(viewsets.GenericViewSet):
    ...
    def recent_activity(self, request):
        ...
        recent = self.get_queryset().order_by('-date')[:limit]
    ...
    def financial_health(self, request):
        ...
        return Response({
            ...
            'expense_to_income_ratio': round(
                float((total_expenses / total_income * 100)) if total_income > 0 else 0, 2
            ),
            ...
            'daily_average_expense': float(total_expenses / 30) if total_expenses > 0 else 0
        })
